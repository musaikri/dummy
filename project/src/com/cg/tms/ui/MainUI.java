...
boolean check=false;
		...
		do {
			...
			switch (choice) {
			case 1:
				List<String> category=service.listTicketCategory();
				int count=0;
				for (String string : category) {
				//	String t=category.get(count);
					System.out.println(count+". "+category.get(count));
					count++;
				}
				...
				System.out.println("Ticket Number "+ticketBean.getTicketNo()+" logged Successfully at "+date1);
				}else{
